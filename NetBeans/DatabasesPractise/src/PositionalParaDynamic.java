...
public class PositionalParaDynamic{
...
//            String C=sc.next();
        ...
        PreparedStatement ps=con.prepareStatement("select * from Desk where RollNo = ? ");
         ps.setInt(1, R);
        ...
        ResultSetMetaData rsmd=rs.getMetaData();
            ...
            while(rs.next())
         {
             System.out.println("\t"+rs.getString(1)+"\t"+rs.getInt(2)+"\t"+rs.getInt(3)+"\t"+rs.getInt(4)+"\t"+rs.getString(5)+"\t"+rs.getInt(6));
         }
