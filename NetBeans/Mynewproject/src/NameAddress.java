...
public class MyFrameOne extends Frame implements WindowListener,ActionListener
{
     ...
     public MyFrameOne()
    {
        ...
        lb3.setBounds(50,100,150,30);
        this.add(lb3);
        lb4=new Label("Enter your Mother's Name: ");
        lb4.setBounds(50,130,150,30);
        this.add(lb4);
        lb5=new Label("Enter your Address : ");
        lb5.setBounds(50,160,150,30);
        this.add(lb5);
        lb6=new Label("Enter your Subject : ");
        lb6.setBounds(50,200,150,30);
        this.add(lb6);
        ...
        bn1.setBounds(150,290,200,50);
        bn1.setBackground(Color.PINK);
        
        
        lb7=new Label();
        lb7.setBounds(130,310,250,30);
        this.add(lb7);
        lb8=new Label();
        lb8.setBounds(130,320,350,50);
        this.add(lb8);
        lb9=new Label();
        lb9.setBounds(130,330,250,30);
        this.add(lb9);
        lb10=new Label();
        lb10.setBounds(130,340,350,50);
        this.add(lb10);
        lb11=new Label();
        lb11.setBounds(130,350,250,30);
        this.add(lb11);
        lb12=new Label();
        lb12.setBounds(130,360,350,50);
        this.add(lb12);
